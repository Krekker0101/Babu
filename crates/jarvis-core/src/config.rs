...
pub fn get_wake_grammar(lang: &str) -> &'static [&'static str] {
    match lang {
        "ru" => &[
            "бабу", "[unk]", "бобу", "привет", "давай",
        ],
        "ua" => &[
            "бабу", "[unk]", "бобу", "привіт", "давай",
        ],
        "en" => &[
            "babu", "[unk]", "baby", "hello", "hey", "hi",
        ],
        _ => &["babu", "[unk]"],
    }
}