    ...
    match Rustpotter::new(&rustpotter_config) {
        Ok(mut rinstance) => {
            ...
            let rustpotter_wake_word_files: [&str; 1] = [
                "resources/rustpotter/babu-default.rpw",
                // "rustpotter/babu-community-1.rpw",
                // "rustpotter/babu-community-2.rpw",
                // "rustpotter/babu-community-3.rpw",
                // "rustpotter/babu-community-4.rpw",
                // "rustpotter/babu-community-5.rpw",
            ];
